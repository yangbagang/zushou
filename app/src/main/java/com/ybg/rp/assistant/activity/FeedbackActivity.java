...
/**
 * Created by yangbagang on 2016/10/10.
 */

public class FeedbackActivity extends ActivityWebViewExtra {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "file:///android_asset/html/feedback/index.html?server=" +
